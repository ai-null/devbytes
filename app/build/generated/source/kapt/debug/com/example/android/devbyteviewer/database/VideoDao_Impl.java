...
public final class VideoDao_Impl implements VideoDao {
  ...
  public VideoDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDatabaseVideo = new EntityInsertionAdapter<DatabaseVideo>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `database_video`(`url`,`title`,`description`,`thumbnail`,`updated`) VALUES (?,?,?,?,?)";
      }
  ...
  public LiveData<List<DatabaseVideo>> getVideos() {
    final String _sql = "SELECT * FROM database_video";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return __db.getInvalidationTracker().createLiveData(new String[]{"database_video"}, false, new Callable<List<DatabaseVideo>>() {
      @Override
      public List<DatabaseVideo> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new DatabaseVideo(_tmpUrl,_tmpTitle,_tmpDescription,_tmpThumbnail,_tmpUpdated);
            _result.add(_item);
          }
          return _result;
        } finally {
